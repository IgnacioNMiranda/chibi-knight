...
class RoleUtil {
    static defineRoles(participationPoints, user, message) {
        ...
        const botRolesExistingInUser = userRoles.filter((userRole) => availableBotRoles.find((role) => role.name === userRole.name) !==
            undefined);
        let nextAvailableRole = this.roles
            .ZOTE;
    ...
    static applyRole(role, user, message) {
    ...
    static initRoles(message) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { guild } = message;
                const botRoles = Object.values(this.roles);
                botRoles.forEach((role) => __awaiter(this, void 0, void 0, function* () {
                ...
                logger_1.default.error(`Authorization error. Does not have enough permissions on '${message.guild.name}' server to create roles`, { context: this.constructor.name });
            }
            return false;
        });
    }
    static removeRoles(guild) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const botRoles = Object.values(this.roles);
                botRoles.forEach((role) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (existingRole) {
                        yield existingRole.delete('Bot fired from server');
                    }
                }));
                return true;
            }
            catch (error) {
                logger_1.default.error(`Authorization error. Does not have enough permissions on '${guild.name}' server to delete roles`, { context: this.constructor.name });
            }
            return false;
        });
    }
}
exports.default = RoleUtil;
RoleUtil.roles = {
    ZOTE: {
        name: 'Zote',
        requiredPoints: 50,
...
RoleUtil.ROLE_COLOR = configuration_1.default.embedMessageColor;
